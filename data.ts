...
export const TRANSLATIONS: Record<Language, SiteData> = {
  nl: {
    ...
    projects: [
      { id: 'vid-5', title: 'Featured Release', category: 'Cinematography', thumbnail: 'https://img.youtube.com/vi/LyGzBkXwBY8/maxresdefault.jpg', description: 'Onze nieuwste cinematische productie.', year: '2025', videoUrl: 'https://www.youtube.com/watch?v=LyGzBkXwBY8' },
  ...
  en: {
    ...
    projects: [
      { id: 'vid-5', title: 'Featured Release', category: 'Cinematography', thumbnail: 'https://img.youtube.com/vi/LyGzBkXwBY8/maxresdefault.jpg', description: 'Our latest cinematic production.', year: '2025', videoUrl: 'https://www.youtube.com/watch?v=LyGzBkXwBY8' },
